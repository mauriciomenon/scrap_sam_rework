...
class SSADashboard:
    ...
    def _create_hover_text(self, ssas, title):
        """Cria o texto de hover para gráficos."""
        if len(ssas) == 0:
    ...
    def _create_ssa_list(self, ssas):
        """Cria lista de SSAs clicáveis com copiar e link."""
    ...
    def _get_chart_config(self):
        """
        Retorna configurações de gráfico do Plotly.

        Returns:
            dict: Configurações para os gráficos
        """
        return {
            "displayModeBar": True,
            "scrollZoom": False,
    ...
    def _enhance_bar_chart(self, fig, chart_type, title, df_filtered=None):
        """Melhora gráfico de barras com hover e dados clicáveis sem mutar traços in-place."""
    ...
    def setup_callbacks_legacy(self):
        ...
        # Callbacks de cópia de SSAs (todas e individuais)
    ...
    # (antigo callback de ssa-number removido e substituído pelos acima)
